...
import { aminaProducts } from "./data";

const loadMotionFeatures = () =>
  import("framer-motion").then((mod) => mod.domAnimation);

const aminaHeroFont = Bodoni_Moda({
  subsets: ["latin"],
  weight: ["400", "500", "600", "700"],
});

const aminaProductFont = Playfair_Display({
  subsets: ["latin"],
  weight: ["400", "500", "600", "700"],
});
...
const products = aminaProducts.map((product) => ({
  slug: product.slug,
  name: product.name,
...
const sortOptions = [
  ...
  { key: "series", label: "Family", description: "Grouped by family" },
] as const;
...
const IconCollabHeader = ({ className, ...p }: any) => (
  <svg
    ...
    {...p}
  >
    {/* “application” – app window with a highlighted section */}
    <rect
      x="3"
      y="4"
      width="14"
    ...
    <rect
      ...
      opacity="0.7"
    />
    {/* highlighted application tile on the right */}
    <rect
      x="11"
      y="8.5"
      width="5"
...
/* ---------- page ---------- */
export default function AminaCollection() {
  ...
  return (
    ...
    <section
          className="relative w-full max-w-[1440px] mx-auto px-4 pt-12 pb-10
                    ...
                    lg:px-10 lg:pt-24"
          > 
          {/* Hero (aligned with Trinnov style) */}
          <m.div
          ...
          >
            ...
            <h1
              className={`${aminaHeroFont.className} text-[clamp(2.4rem,6vw,4.3rem)] font-light leading-[1.02] tracking-[-0.02em] text-[#1A1A1A]`}
            >
             AMINA Products
            </h1>

            <p className="text-[0.95rem] sm:text-[1.02rem] lg:text-[1.06rem] leading-[1.8] text-[rgba(26,26,26,0.7)] max-w-3xl">
              Edge drywall panels, Mobius multi-material transducers, Sapphire
              Symphony Cell loudspeakers, and ALF bass architectures selected
              from aminasound.com for Malaysian interiors that demand
              architecture-first sound. Explore by family, surface, or
              application.
            </p>
          </m.div>
          ...
          >
            ...
            <div className="space-y-6 sm:space-y-8 pt-4">
                    ...
                    >
                      ...
                      <div className="flex flex-1 flex-col px-5 sm:px-6 lg:px-9 pt-3 sm:pt-4 lg:pt-5 pb-16 sm:pb-18 lg:pb-20 text-left">
                        <div className="max-w-[30rem]">
                          <h2
                            className={`${aminaProductFont.className} text-[1.8rem] sm:text-[2rem] lg:text-[2.35rem] leading-[1.05] font-light text-[#1A1A1A]`}
                          >
                            <Link
                              href={`/products/amina/${item.slug}`}
              ...
              {/* Pagination (same pattern as Trinnov) */}
              ...
              {!productsList.length && (
                <div className="rounded-[16px] sm:rounded-[20px] lg:rounded-[24px] bg-white/70 px-4 sm:px-6 py-8 sm:py-10 text-center text-[0.85rem] sm:text-sm text-[rgba(26,26,26,0.6)] shadow">
                  No Amina editions match the current filters. Adjust your
                  selection or{" "}
                  <Link
                    href="/contact"
                    ...
                    <div className="mb-6">
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder="Search Amina products..."
