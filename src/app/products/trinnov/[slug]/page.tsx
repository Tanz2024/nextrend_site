// app/products/trinnov/[slug]/page.tsx
// @ts-nocheck
"use client";
...
import { trinnovProducts as productData } from "../data";
      ...
      >
        <section className="relative z-10 mx-auto w-full max-w-[1280px] px-4 pb-8 pt-4 sm:px-6 sm:pb-16 sm:pt-8 md:px-12 md:pb-20 md:pt-12 lg:px-20">
          ...
          >
            ...
            <Link href="/products/trinnov" className="hover:text-[#C4A777]">
              {product.brand ?? "Trinnov"}
            </Link>
            <span className="mx-1 sm:mx-2 opacity-30">/</span>
 ...
 */}
          ...
          <ProductNavButtons
            prev={prev ?? undefined}
            next={next ?? undefined}
            resolveHref={(link) => "/products/trinnov/" + link.slug}
          />
        </section>
