...
const mapProduct = (raw: any): FrogisProduct => {
  ...
  return {
    ...
    image: buildFrogisUrl(`Ceiling speakers/${raw.image}`),
    lifestyle: mapLifestyle(raw.lifestyle || []),
  };
};

export const ceilingSpeakersProducts: FrogisProduct[] = (data as any[]).map(mapProduct);
